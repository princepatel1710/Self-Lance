...
public class CompleteProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirstName = findViewById(R.id.edtFN);
        LastName = findViewById(R.id.edtLN);
        ...
        save_btn = findViewById(R.id.save_edit_profile);


        skill_1 = findViewById(R.id.cb_skill_1);
        skill_2 = findViewById(R.id.cb_skill_2);
        skill_3 = findViewById(R.id.cb_skill_3);
        skill_4 = findViewById(R.id.cb_skill_4);
        skill_5 = findViewById(R.id.cb_skill_5);
        skill_6 = findViewById(R.id.cb_skill_6);
    ...
    private boolean isDataComplete() {
        ...
        if (TextUtils.isEmpty(firstName)) {
            ...
            Toast.makeText(this, "Select atleast one skill", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
    ...
    public void signUp() {
        prgDialog = new ProgressDialog(CompleteProfile.this);
        ...
        reference.child(userID).setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                prgDialog.dismiss();
                final AlertDialog.Builder builder = new AlertDialog.Builder(CompleteProfile.this);
